...
#ifdef HSPACE
#define CMD_ONE_ARG_PASS_SWITCH(name) \
    extern void FDECL(name, (dbref, dbref, int, char *, char *))
#define CMD_TWO_ARG_PASS_SWITCH(name) \
    extern void FDECL(name, (dbref, dbref, int, char *, char *, char *))
#endif /* HSPACE */
...
CMD_TWO_ARG_PASS_SWITCH(do_hs_space);
CMD_TWO_ARG_PASS_SWITCH(do_hs_nav);
CMD_TWO_ARG_PASS_SWITCH(do_hs_eng);
CMD_TWO_ARG_PASS_SWITCH(do_hs_console);
CMD_ONE_ARG(do_hs_man);
CMD_ONE_ARG(do_hs_unman);
...
#ifdef HSPACE
#define CS_PASS_SWITCH	0x10000	/* Passes switches to command handler */
#endif /* HSPACE */
