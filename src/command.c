...
{(char *)"@console",		NULL,		CA_PUBLIC,
	0,		CS_TWO_ARG|CS_PASS_SWITCH,	
	NULL,			NULL,		do_hs_console},
{(char *)"@eng",		NULL,		CA_PUBLIC,
	0,		CS_TWO_ARG|CS_PASS_SWITCH,	
	NULL,			NULL,		do_hs_eng},
{(char *)"@nav",		NULL,		CA_PUBLIC,
	0,		CS_TWO_ARG|CS_PASS_SWITCH,	
	NULL,			NULL,		do_hs_nav},
{(char *)"@space",		NULL,		CA_PUBLIC,
	0,		CS_TWO_ARG|CS_PASS_SWITCH,	
	NULL,			NULL,		do_hs_space},
{(char *)"board",		NULL,		CA_PUBLIC,
	0,		CS_TWO_ARG,	
	NULL,			NULL,		do_hs_board},
{(char *)"disembark",		NULL,		CA_PUBLIC,
	0,		CS_ONE_ARG,	
	NULL,			NULL,		do_hs_disembark},
{(char *)"man",		NULL,		CA_PUBLIC,
	0,		CS_ONE_ARG,	
	NULL,			NULL,		do_hs_man},
{(char *)"unman",		NULL,		CA_PUBLIC,
	0,		CS_ONE_ARG,	
	NULL,			NULL,		do_hs_unman},
#endif /* HSPACE */
{(char *)NULL,			NULL,		0,
	0,		0,				
	NULL,		NULL,			NULL}};
...
#ifdef HSPACE
		    } else if (cmdp->callseq & CS_PASS_SWITCH) {
		    	(*(cmdp->info.handler)) (player, cause, key, buf1,
		    		switchp);
#endif /* HSPACE */
		    } else 
