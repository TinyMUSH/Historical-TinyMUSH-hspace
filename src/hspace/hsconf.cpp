...
HCONF   hspace_conflist[] =
{
  ...
  (char *) "engines_activating", HSCfStr, (int *) HSCONF.engines_activating,
  (char *) "life_activating", HSCfStr, (int *) HSCONF.life_activating,
  (char *) "thrusters_activating", HSCfStr, (int *) HSCONF.thrusters_activating,
  (char *) "reactor_activating", HSCfStr, (int *) HSCONF.reactor_activating,
  (char *) "computer_activating", HSCfStr, (int *) HSCONF.computer_activating,
