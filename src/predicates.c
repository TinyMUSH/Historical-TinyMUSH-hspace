...
#if defined(HSPACE) && !defined(STANDALONE)
void do_hs_space(player, cause, key, arg_left, arg_right, switches)
dbref player, cause;
int key;
char *arg_left;
char *arg_right;
char *switches;
{
  (void) upcasestr(switches);
  hsCommand("@space", switches, arg_left, arg_right, player);
}

void do_hs_nav(player, cause, key, arg_left, arg_right, switches)
dbref player, cause;
int key;
char *arg_left;
char *arg_right;
...
void do_hs_eng(player, cause, key, arg_left, arg_right, switches)
dbref player, cause;
int key;
char *arg_left;
char *arg_right;
...
void do_hs_console(player, cause, key, arg_left, arg_right, switches)
dbref player, cause;
int key;
char *arg_left;
char *arg_right;
...
void do_hs_man(player, cause, key, arg_left)
dbref player, cause;
int key;
char *arg_left;
{
...
void do_hs_unman(player, cause, key, arg_left)
dbref player, cause;
int key;
char *arg_left;
{
...
void do_hs_disembark(player, cause, key, arg_left)
dbref player, cause;
int key;
char *arg_left;
{
...
void do_hs_board(player, cause, key, arg_left, arg_right)
dbref player, cause;
int key;
char *arg_left;
char *arg_right;
